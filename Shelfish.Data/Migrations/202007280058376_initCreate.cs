namespace Shelfish.Data.Migrations
{
    ...
    public partial class initCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.ShelfAudioRecordKeeper",
                c => new
                    {
                        AudioRecordKeeperId = c.Int(nullable: false, identity: true),
                        ShelfId = c.Int(nullable: false),
                        AudiobookId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.AudioRecordKeeperId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ShelfAudioRecordKeeper", "ShelfId", "dbo.Bookshelf");
            DropForeignKey("dbo.ShelfAudioRecordKeeper", "AudiobookId", "dbo.Audiobook");
            ...
            DropIndex("dbo.ShelfAudioRecordKeeper", new[] { "AudiobookId" });
            DropIndex("dbo.ShelfAudioRecordKeeper", new[] { "ShelfId" });
            ...
            DropTable("dbo.ShelfAudioRecordKeeper");
